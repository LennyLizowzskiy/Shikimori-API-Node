    ...
    constructor (shikimori) {
        ...
        this.request = {
            ...
            async delete(method, id) {
                return needle('delete', `${apilink}/${method}/${id}`, data, {headers: {'user-agent': `User-Agent: ${shikimori.auth.credentials.useragent}`}}).then((res) => {
                    return res.body;
                });
            }
        }
        ...
        this.getAchievements = async (userid) => {
        ...
        this.animes = {
            ...
            async getTopics(id) {
                return shikimori.api.request.get(`animes/${id}/topics`);
            }
        }

        // https://shikimori.one/api/doc/1.0/appear/create.html
        this.appear = async (ids) => {
        ...
        this.getCalendar = async () => {
            return shikimori.api.request.get('calendar');
        }
        ...
        this.characters = {
            ...
            async search(searchString) {
                return shikimori.api.request.get('characters/search', { search: searchString });
            }
        }
        ...
        this.clubs = {
            ...
            async update(id, obj) {
                return shikimori.api.request.put(`clubs`, id, { club: obj });
            },
        ...
        this.messages = {
            ...
            async send(obj) {
                return shikimori.api.request.post('messages', obj);
            },

            // https://shikimori.one/api/doc/1.0/messages/update.html
            async update(id, obj) {
                return shikimori.api.request.put(`messages`, id, obj);
            },
            ...
            async markAsRead(obj) {
                return shikimori.api.request.post('messages/mark_read', obj);
            },
        ...
        this.styles = {
            ...
            async preview(obj) {
                return shikimori.api.request.post('styles/preview', obj);
            },

            // https://shikimori.one/api/doc/1.0/styles/create.html
            async create(obj) {
                return shikimori.api.request.post('styles', obj);
            },

            // https://shikimori.one/api/doc/1.0/styles/update.html
            async update(id, obj) {
                return shikimori.api.request.put(`styles`, id, obj);
            }
        }
        ...
        async function createUserImage(obj) {
        ...
        this.users = {
            ...
            whoAmI: () => {return this.users.whoami()},
            ...
            getFavorites: () => {return this.users.getFavourites()},
